...
import air from "../Navbar/images/air.jpeg";
import world from "../Navbar/images/world.jpeg";
import profile from '../Navbar/images/profile.jpeg';
import '../Navbar/nav.scss';
// import search from '../Navbar/images/search.png';
// import AnywhereComponent from "./Anywhere";
// import React, { useState } from "react";
...
import productJson from '../../card.json';
...
const Nav: React.FC <AnywhereProps> = ({ setFilterAnyState }: AnywhereProps) => {
  ...
  const handleSearchButtonClick = () => {
    const formattedCheckInDate = checkInDate ? format(checkInDate, 'yyyy-MM-dd') : '';
    const formattedCheckOutDate = checkOutDate ? format(checkOutDate, 'yyyy-MM-dd') : '';
    ...
    const filteredData = productJson.filter((item) => {
      if (selectedCountry && checkInDate && checkOutDate && countAdults && countChildren && countInfants && countPets) {
        return (
      ...
      } else if (selectedCountry && checkInDate && countAdults && countChildren && countInfants && countPets) {
        return (
          item.location === selectedCountry &&
          item.checkInDate === formattedCheckInDate &&
          item.guests.adults === countAdults &&
      ...
      } else if (selectedCountry && checkOutDate && countAdults && countChildren && countInfants && countPets) {
        return (
          item.location === selectedCountry &&
          item.checkOutDate === formattedCheckOutDate &&
          item.guests.adults === countAdults &&
      ...
      } else if (checkInDate && checkOutDate && countAdults && countChildren && countInfants && countPets) {
        return (
          item.checkInDate === formattedCheckInDate &&
          item.checkOutDate === formattedCheckOutDate &&
          item.guests.adults  === countAdults &&
      ...
      {isAnywhereOpen ? (
          ...
          <div className="nav-middle-second">
            <div className="anywhere-expand-field">
              <button
                className={`stays-button ${activeButton === "stays" ? "active" : ""}`}
                onClick={() => handleButtonClick("stays")}
              >
                Stays
              </button>
              <button
                className={`experiences-button ${activeButton === "experiences" ? "active" : ""}`}
                onClick={() => handleButtonClick("experiences")}
              >
                Experiences
              </button>
              <button
                className={`online-experiences-button ${activeButton === "online-experiences" ? "active" : ""}`}
            ...
            <div className="nav-stays">
              <div className="nav-stays-middle-button">
                <div className="where-button-div">
                  <button
                    className={`stays-anywhere-button ${activeButton === "anywhere" ? "active" : ""}`}
                ...
                <div className="checkIn-button-div">
                  <button
                    className={`stays-checkIn-button ${activeButton === "checkIn" ? "active" : ""}`}
                ...
                <div className="checkOut-button-div">
                  <button
                    className={`stays-checkOut-button ${activeButton === "checkOut" ? "active" : ""}`}
                ...
                <div className="who-button-div">
                  <button
                    className={`stays-guests-button ${activeButton === "who" ? "active" : ""}`}
                    onClick={() => handleButtonClick("who")}
                  >
                    who
                  </button>
                  <div>
                    <button className="stays-add-guests-button" onClick={handleSearchButtonClick}>
                      <img src={search} className="search" alt="My Image" />
                      <span style={{ color: 'white', marginTop: '-1px' }}>&nbsp;search</span>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="who-card">
                ...
                <div className="adults">
                  ...
                  <div className="button-circle-adults">
                    <button className="button-circle__decrement" onClick={decrementAdults}>
                      -
                    </button>
                    <div className="button-circle__value">&nbsp;{countAdults}&nbsp;</div>
                    <button className="button-circle__increment" onClick={incrementAdults}>
                      +
                    </button>
                  </div>
                ...
                <div className="children">
                  ...
                  <div className="button-circle-children">
                    <button className="button-circle__decrement" onClick={decrementChildren}>
                      -
                    </button>
                    <div className="button-circle__value">&nbsp;{countChildren}&nbsp;</div>
                    <button className="button-circle__increment" onClick={incrementChildren}>
                      +
                    </button>
                  </div>
                ...
                <div className="infants">
                  ...
                  <div className="button-circle-infants">
                    <button className="button-circle__decrement" onClick={decrementInfants}>
                      -
                    </button>
                    <div className="button-circle__value">&nbsp;{countInfants}&nbsp;</div>
                    <button className="button-circle__increment" onClick={incrementInfants}>
                      +
                    </button>
                  </div>
                ...
                <div className="pets">
                  ...
                  <div className="button-circle-pets">
                    <button className="button-circle__decrement" onClick={decrementPets}>
                      -
                    </button>
                    <div className="button-circle__value">&nbsp;{countPets}&nbsp;</div>
                    <button className="button-circle__increment" onClick={incrementPets}>
                      +
                    </button>
                  </div>
            ...
            <div className="nav-middle-button">
              ...
              <div className="anyweek-button-div">
                <button className="any-week-button">
                  <span style={{ color: 'grey' }}> |&nbsp;&nbsp; </span>Any week
